...
export function generateVehicleData() {
  ...
  return {
    ...
    temperature: vehicleState.temperature,
    ...
    battery: Number(vehicleState.battery.toFixed(1)),
    emergency: vehicleState.emergency,
    event: activeEvent || "Normal",
